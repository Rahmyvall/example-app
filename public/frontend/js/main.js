...
window.goToLogin = function () {
    ...
    // kalau belum login → buka login offcanvas
    const lofc = document.querySelector('#lofc');

    if (lofc) {
        swTab('login'); // pastikan fungsi ini ada
        lofc.classList.add('show');
    } else {
        alert("Login modal (#lofc) tidak ditemukan");
    }
};
/*  PRICING TOGGLE  */
