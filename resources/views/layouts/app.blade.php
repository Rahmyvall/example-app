        ...
        <div class="main-menu">
            ...
            <div class="logo-box">
                ...
                <a href="index.html" class="logo-light">
                    ...
                    <span class="logo-sm fw-bold text-white" style="font-size: 14px;">
                        AP
                    </span>
                </a>
                ...
                <div class="topbar">
                    <div class="topbar-menu d-flex align-items-center gap-lg-2 gap-1">
                        ...
                        <div class="logo-box">
                            <!-- Brand Logo Light -->
                            <a href="index.html" class="logo-light">
                                <img src="assets/images/logo-light.png" alt="logo" class="logo-lg" height="105">
                                <img src="assets/images/logo-sm.png" alt="small logo" class="logo-sm" height="105">
                            </a>

                            <!-- Brand Logo Dark -->
                            <a href="index.html" class="logo-dark">
                                <img src="assets/images/logo-dark.png" alt="dark logo" class="logo-lg" height="105">
                                <img src="assets/images/logo-sm.png" alt="small logo" class="logo-sm" height="105">
                            </a>
                        </div>
